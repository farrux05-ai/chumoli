"""
uzpipe.core.manifest
=====================

Bu modul UzPipe'ning eng kritik "shartnomasi": har bir connector
...
shifrlangan holda saqlanishi SHART (qarang: uzpipe.security.crypto).
...
class ConnectorManifest(BaseModel):
    ...
    `uzpipe.connectors.base.BaseUZConnector` implementatsiyasida turadi.
    ...
    dlt_source_factory: str = Field(
        ...
        description=(
            ...
            "Masalan 'uzpipe.connectors.rest_api.connector.RestApiConnector'. "
