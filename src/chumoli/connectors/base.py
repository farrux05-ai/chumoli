...
Chumoli connector'i faqat "yupqa moslashtiruvchi" (thin adapter) bo'lishi
...
Bu connector muallifiga MAKSIMAL erkinlik beradi, lekin Chumoli'ning
...
from chumoli.core.manifest import ConnectorManifest
...
class ConnectorRegistry:
    ...
    connectorlarni topadi. Hech kim `chumoli.connectors.payme_uz.connector`
