"""chumoli.store.control_store — pipeline configs + encrypted secrets + settings."""
...
class ControlStore:
    ...
    def _default_db_path() -> Path:
        from chumoli.core.paths import ensure_runtime_dirs, chumoli_home
        ensure_runtime_dirs()
        return chumoli_home() / "chumoli_control.db"
