# UzPipe — API / Connector Maintenance Strategy
...
2. **Automation** (Grok Automations): har dushanba “uzpipe open maintenance issues’ni ko‘r” deb eslatma.  
...
Keyingi qadam: MVP workflow’ni `uzpipe` repoga yozish (secret’larsiz skeleton) yoki avval qaysi 2 connector’dan boshlashni tanlash.
